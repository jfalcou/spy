...
int main()
{
  ...
  std::cout << "Check that ARM SIMD extension detection is correct: " << std::endl;
  {
    ...
    std::cout << "SVE (fixed)  status: " << std::boolalpha << (spy::simd_instruction_set == spy::fixed_sve_)
              << std::endl;
    std::cout << "SVE2         status: " << std::boolalpha << (spy::simd_instruction_set == spy::sve2_) << std::endl;
    std::cout << "SVE2 (fixed) status: " << std::boolalpha << (spy::simd_instruction_set == spy::fixed_sve2_)
              << std::endl;
  ...
  std::cout << "Check that PPC SIMD extension detection is correct: " << std::endl;
  {
    ...
    std::cout << " |- ISA v2.03 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vmx_2_03_)
              << std::endl;
    std::cout << " |- ISA v2.05 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vmx_2_05_)
              << std::endl;
    std::cout << " |- ISA v2.06 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vmx_2_06_)
              << std::endl;
    std::cout << " |- ISA v2.07 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vmx_2_07_)
              << std::endl;
    std::cout << " |- ISA v3.00 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vmx_3_00_)
              << std::endl;
    std::cout << " |- ISA v3.01 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vmx_3_01_)
              << std::endl;
    std::cout << "VSX (Any ISA)   status: " << std::boolalpha << (spy::simd_instruction_set >= spy::vsx_) << std::endl;
    std::cout << " |- ISA v2.06 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vsx_2_06_)
              << std::endl;
    std::cout << " |- ISA v2.07 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vsx_2_07_)
              << std::endl;
    std::cout << " |- ISA v3.00 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vsx_3_00_)
              << std::endl;
    std::cout << " |- ISA v3.01 support : " << std::boolalpha << (spy::simd_instruction_set >= spy::vsx_3_01_)
              << std::endl;
  }
  std::cout << std::endl;
  ...
  {
    std::cout << "RISC-V      status: " << std::boolalpha << (spy::simd_instruction_set == spy::riscv_simd_)
              << std::endl;
    std::cout << "RVV         status: " << std::boolalpha << (spy::simd_instruction_set >= spy::rvv_) << std::endl;
    std::cout << "RVV (fixed) status: " << std::boolalpha << (spy::simd_instruction_set >= spy::fixed_rvv_)
              << std::endl;
