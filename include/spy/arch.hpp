...
#define SPY_ARCH_IS_UNKNOWN
  ...
  //! verify if the code being compiled is compiled for a given CPU architecture.
  //!
  //! Additionally, any of the architecture related value are convertible to `bool`. They evaluates
  //! to `true` if they matches the correct architecture currently targeted.
  //!
